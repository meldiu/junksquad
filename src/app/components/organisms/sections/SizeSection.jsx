  ...
  return (
    <div className={styles.container}>
      ...
      <p className={`${styles.paragraph} ${styles['paragraph-3']}`}>
        <strong>{`So, don't hesitate to reach out to us, no matter the size or scope of your junk removal requirements. We're here to make your life easier, one load at a time.`}</strong>
      </p>
    </div>
  )
}
